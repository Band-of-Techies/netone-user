        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              if (numberOfPersons > 1) applicantDetails(2, applicants[1]),
              if (numberOfPersons > 2) applicantDetails(3, applicants[2]),
              if (numberOfPersons > 3) applicantDetails(4, applicants[3]),
              Row(
                children: [
                  CustomText(
